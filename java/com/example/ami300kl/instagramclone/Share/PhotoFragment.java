...
public class PhotoFragment extends Fragment {
    ...
    private static int GALLERY_FRAGMENT_NUM =0;
    private static int PHOTO_FRAGMENT_NUM =1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        Button btnLounchCamera=(Button)view.findViewById(R.id.btnLauncCamera);
        btnLounchCamera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d(TAG, "onClick: lounching camera");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE) {
            ...
            Log.d(TAG, "onActivityResult: attempting to navigate");
            //navigate to finals screen to publish a photo
            ...
            {
                try{
                    Log.d(TAG, "onActivityResult: recived new bitmap");
